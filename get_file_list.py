...
url_perfmon = 'https://' + cucm + ':8443/logcollectionservice/services/LogCollectionPort?wsdl'
test  = suds.client.Client(url_perfmon,username=ccmuser,password=ccmpwd,doctor=doctor)
resultat2 = test.service.ListNodeServiceLogs()
